...
/**
    ...
    try
    {
        ...
        entree.open("../AutreLaby/Lab8x8/rouge8x8.txt", ios::in);
        ...
        lab3.chargeLabyrinthe(Couleur::Rouge, entree);
        cout << "\nLabyrinthe rouge chargé.\n";
        entree.close(); //on ferme le fichier

        entree.open("AutreLaby/Lab8x8/vert8x8.txt", ios::in);
        if (!entree.is_open())
        {
            cout << "Fichier vert introuvable.\n";
            return 1;
        ...
        lab3.chargeLabyrinthe(Couleur::Vert, entree);
        cout << "\nLabyrinthe vert chargé.\n";
        entree.close();

        entree.open("AutreLaby/Lab8x8/bleu8x8.txt", ios::in);
        if (!entree.is_open())
        {
            cout << "Fichier bleu introuvable.\n";
            return 1;
        ...
        lab3.chargeLabyrinthe(Couleur::Bleu, entree);
        cout << "\nLabyrinthe bleu chargé.\n";
        entree.close();

        entree.open("AutreLaby/Lab8x8/jaune8x8.txt", ios::in);
        if (!entree.is_open())
        {
            cout << "Fichier jaune introuvable.\n\n";
            return 1;
        ...
        lab3.chargeLabyrinthe(Couleur::Jaune, entree);
        cout << "\nLabyrinthe jaune chargé.\n";
        entree.close();

        cout << "\nLe joueur rouge peut solutionner le labyrinthe en "
             << lab3.solutionner(Couleur::Rouge) << " déplacements.\n";
        cout << "\nLe joueur vert peut solutionner le labyrinthe en "
             << lab3.solutionner(Couleur::Vert) << " déplacements.\n";
        cout << "\nLe joueur bleu peut solutionner le labyrinthe en "
             << lab3.solutionner(Couleur::Bleu) << " déplacements.\n";
        cout << "\nLe joueur jaune peut solutionner le labyrinthe en "
             << lab3.solutionner(Couleur::Jaune) << " déplacements.\n";

        Couleur LeGagnant = lab3.trouveGagnant();
        switch (LeGagnant)
        {
            case Couleur::Rouge:
                cout << endl << "Le joueur gagnant: Rouge" << endl << endl; break;
